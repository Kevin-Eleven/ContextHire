...
CALIBRATION (measured on 20K of the pool, so cliffs sit at real distribution points, not guesses):
  profile_completeness 25-99 (med 56) · recruiter_response_rate 0.04-0.94 (med 0.44)
  last_active_days 25-265 (med 129) · interview_completion_rate 0.30-1.00 (med 0.62)
...
def behavioral_modifier(f: dict) -> tuple[float, list[str]]:
    ...
    # Not actively job-seeking — the single strongest availability signal (only 35% are open).
